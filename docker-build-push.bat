...
docker build -t kafka-sparka-api ./message-broker/kafka-sparka-api
...
docker tag kafka-sparka-api docker.io/equehours/kafka-sparka-api
...
docker push docker.io/equehours/kafka-sparka-api
